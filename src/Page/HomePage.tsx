      ...
      return (
        <div >
            ...
            <div className="flex justify-center items-center border-[1px] border-neutral-300 mb-7">
                <InputField placeholder="Search Item" className="max-sm:w-[100%]" setFilteredTasks={setFilteredTasks} />
